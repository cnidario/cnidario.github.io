...
var Module = typeof AS !== 'undefined' ? AS : {};
...
function gen_output_cb(msg_cb) {
    var buff = [];
    return function(_char) {
	if(_char !== null)
	    buff.push(_char);
	if(_char === null || _char === 10) { //flush
	    var msg = buff.map(x => String.fromCharCode(x)).join('');
	        msg_cb(msg);
            buff = [];
	}
    }
} 
Module.stdout_messages = [];
Module.stderr_messages = [];
Module.preRun = function() {
    FS.init(input_cb, gen_output_cb(m => Module.stdout_messages.push(m)), gen_output_cb(m => Module.stderr_messages.push(m)));
}
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 571072,
    DYNAMIC_BASE = 5813952,
    DYNAMICTOP_PTR = 570912;
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_current=570928;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 570976, 4), 570976);
...
var asmGlobalArg = {};
var asmLibraryArg = { "__lock": ___lock, "__map_file": ___map_file, "__syscall10": ___syscall10, "__syscall15": ___syscall15, "__syscall183": ___syscall183, "__syscall191": ___syscall191, "__syscall195": ___syscall195, "__syscall196": ___syscall196, "__syscall197": ___syscall197, "__syscall199": ___syscall199, "__syscall200": ___syscall200, "__syscall201": ___syscall201, "__syscall202": ___syscall202, "__syscall220": ___syscall220, "__syscall221": ___syscall221, "__syscall3": ___syscall3, "__syscall33": ___syscall33, "__syscall340": ___syscall340, "__syscall5": ___syscall5, "__syscall54": ___syscall54, "__syscall60": ___syscall60, "__syscall77": ___syscall77, "__syscall85": ___syscall85, "__syscall91": ___syscall91, "__unlock": ___unlock, "__wait": ___wait, "_exit": __exit, "abort": _abort, "abs": _abs, "dlclose": _dlclose, "dlerror": _dlerror, "dlopen": _dlopen, "dlsym": _dlsym, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "environ_get": _environ_get, "environ_sizes_get": _environ_sizes_get, "exit": _exit, "fd_close": _fd_close, "fd_fdstat_get": _fd_fdstat_get, "fd_read": _fd_read, "fd_seek": _fd_seek, "fd_write": _fd_write, "localtime": _localtime, "memory": wasmMemory, "raise": _raise, "setTempRet0": _setTempRet0, "signal": _signal, "strftime": _strftime, "sysconf": _sysconf, "table": wasmTable, "time": _time };
var asm = createWasm();
